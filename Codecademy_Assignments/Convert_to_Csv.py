"""
Convert the data sorted as a tuple in the big_list into a csv(comma separated value) type document.
"""
# Example 1
import csv
...
with open("access_log.csv", "w") as ac_log:
    fields = ["time", "limit", "address"]
    ac_log_writer = csv.DictWriter(ac_log, fieldnames=fields)

    ac_log_writer.writeheader()
    for item in access_log:
        ac_log_writer.writerow(item)
